    ...
    <section id="inner" class="inner-section section" style="margin-bottom: 30px;">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <p class="wow fadeIn" data-wow-duration="2s" style="margin-bottom: 50px;">Manage</p>
                </div>
            </div>
                    ...
                    <table id="CART" class="table table-bordered table-responsive table-striped">
                        ...
                        <?php foreach($carts as $cart): ?>
                            <tr>
                                ...
                                <form class="delete" action="/contacts/deleteadmin?masp=<?=$cart->Masanpham?>" 
